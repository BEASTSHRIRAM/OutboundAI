      ...
      <CardHeader className="bg-[#1C1C1E] border-b border-[#2C2C2E] py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-2">
            <Badge variant="outline" className="bg-green-500/5 text-green-500 border-green-500/20 px-3 py-1 text-xs">
        ...
        <div className="space-y-3">
          ...
          <div className="relative group">
            ...
            <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity">
              <Badge variant="secondary" className="bg-black/50 text-[10px] text-gray-400 backdrop-blur-sm">
                System Prompt
              </Badge>
            </div>
          </div>
